        ...
        <ImageBackground
          ...
          <View>
            ...
            <Text style={styles.DiscriptionText}>
              Special Package Details are as under here
            </Text>
            <View style={styles.detailContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Name:</Text>
                <Text style={styles.detailTextPre}>Special</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Price:</Text>
                <Text style={styles.detailTextPre}>5000000</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Time:</Text>
                <Text style={styles.detailTextPre}>2:00pm to 7:00pm</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={styles.detailTextPre}>F-10 Markar Road</Text>
              </View>
            </View>
            <TouchableOpacity

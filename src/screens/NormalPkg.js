...
const NormalPkg = props => {
  ...
  const onGotoNormalSummaryScreen = () => {
    props.navigation.navigate(routeNames.NormalSummary);
  };
    ...
    <SafeAreaView style={styles.f1}>
      <ScrollView keyboardShouldPersistTaps="handled">
        <ImageBackground
          ...
          <View style={styles.pkgContainer}>
            <Text style={styles.pkgText}>Price: 400000</Text>
          </View>
          <View style={styles.pkgContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={onGotoNormalSummaryScreen}>

        ...
        <ImageBackground
          ...
          <View>
            ...
            <Text style={styles.DiscriptionText}>
              Classic Package Details are as under here
            </Text>
            <View style={styles.detailContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Name:</Text>
                <Text style={styles.detailTextPre}>Classic</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Price:</Text>
                <Text style={styles.detailTextPre}>700000</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Time:</Text>
                <Text style={styles.detailTextPre}>8:00pm to 10:00pm</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={styles.detailTextPre}>Pwd Double Road</Text>
              </View>
            </View>
            <TouchableOpacity

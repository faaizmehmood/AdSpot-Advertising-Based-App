        ...
        <ImageBackground
          ...
          <View>
            ...
            <Text style={styles.DiscriptionText}>
              Normal Package Details are as under here
            </Text>
            <View style={styles.detailContainer}>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Name:</Text>
                <Text style={styles.detailTextPre}>Normal</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Price:</Text>
                <Text style={styles.detailTextPre}>40000</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
                <Text style={styles.detailText}>Package Time:</Text>
                <Text style={styles.detailTextPre}>2:00pm to 4:00pm</Text>
              </View>
              <View style={{flexDirection: 'row'}}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={styles.detailTextPre}>Peshawar Road</Text>
              </View>
            </View>
            <TouchableOpacity
